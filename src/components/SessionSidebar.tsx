...
import { slideLeft, staggerParent, tapDown } from '../lib/motion'
        ...
        {sessions.length === 0 ? (
          ...
          sessions.map((session) => (
            <motion.div
              ...
              whileHover={{ x: 2 }}
              whileTap={{ scale: 0.99 }}
              className={`group relative mb-0.5 flex w-full items-center gap-2 overflow-hidden rounded-doodle py-2 pl-3 pr-2 text-left text-sm transition-colors cursor-pointer select-none ${
